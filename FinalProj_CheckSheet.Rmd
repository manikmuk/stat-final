...
(A) .Rmd Line numbers where at least two different data sources are imported: 23-25 


(B) .Rmd Line numbers for inspecting data intake: 30-35 
...
(A) .Rmd Line number(s) for general data wrangling: 44-54


(B) .Rmd Line number(s) for a join operation: 70-72


(C) .Rmd Line number(s) for a spread or gather operation (or equivalent): NA


(D) .Rmd Line number(s) for use of regular expressions: 80-82, 89-91


(E) .Rmd Line number(s) for use of reduction and/or transformation functions: NA


(F) .Rmd Line number(s) for use of user-defined functions: 99-106, 112-116


(G) .Rmd Line number(s) for use of loops and/or control flow: 126-130, 137-142
...
(A) .Rmd Line number(s) for use of mulitple different geoms:  175-177, 192-194, 205-206

(B) .Rmd Line number(s) for use of multiple aesthetics:  175-177, 192-194

(C) .Rmd Line number(s) for use of layered graphics:  

(D) .Rmd Line number(s) for use of leaflet maps:  

(E) .Rmd Line number(s) for use of decision tree or dendogram results: 218-219   
